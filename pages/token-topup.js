...
export default function TokenTopup(props) {
  ...
  return (
    <div className="items-left mb-7 mt-9 flex h-fit w-screen flex-col justify-center rounded-sm border border-[#243665] pl-12 pr-7 pb-8 md:mx-4 md:px-7 lg:px-0">
